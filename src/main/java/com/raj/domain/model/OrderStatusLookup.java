 ...
 * @author WhiteWolf
 */
public class OrderStatusLookup implements Serializable {
    ...
    public OrderStatusLookup(Integer id) {
        this.id = id;
    }

    public OrderStatusLookup(Integer id, int name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrderStatusLookup)) {
            return false;
        }
        OrderStatusLookup other = (OrderStatusLookup) object;
    ...
    public String toString() {
        return "com.raj.model.OrderStatusLookup[ id=" + id + " ]";
    }
